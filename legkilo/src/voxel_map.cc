...
void VoxelMapManager::BuildVoxelMap(const Eigen::Matrix3d rot, const Eigen::Matrix3d rot_cov, const Eigen::Matrix3d pos_cov)
{
...
//         if (iter_near != voxel_map_.end()) { build_single_residual(pv, iter_near->second, 0, is_success, prob, single_ptpl); }
//       }
//       if (is_success)
//       {
//         mylock.lock();
