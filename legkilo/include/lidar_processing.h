...
public:
  ...
  void processing(const sensor_msgs::PointCloud2::ConstPtr &msg,
                  common::LidarScan &lidar_scan);

  template <typename T> inline bool blindCheck(const T &p) {
...
private:
  void velodyneHandler(const sensor_msgs::PointCloud2::ConstPtr &msg,
                       common::LidarScan &lidar_scan);
  void ousterHander(const sensor_msgs::PointCloud2::ConstPtr &msg,
                    common::LidarScan &lidar_scan);
  CloudPtr cloud_pcl_;
  Config config_;
};
